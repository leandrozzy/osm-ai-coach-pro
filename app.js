...
const APP_VERSION='4.9.0-cloud-calendar-results';
...
async function handleFiles(files){
 ...
 try{
   ...
   if(!['calendar','result'].includes(analysisMode))applyVisionResult(result);
